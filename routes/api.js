...
router.post('/get_activity',  activitycontroller.get_activity)
...
router.post('/get_custom_activity_detail', authenticateJWT, activitycontroller.get_custom_activity_detail)
...
router.get('/planImageList', user_subscription.planImageList)
